...
export function CheckOutModal({ item, setAlert, setAlerted }) {
    ...
    return (
        <>
            <Button onClick={handleOpen} className="me-3" size="lg" fullWidth={true} variant="gradient" style={{ ml: 6, textTransform: 'inherit' }}>
                Check Out
            </Button>
            <Dialog
                open={open}
                    ...
                    <form className="" onSubmit={onSubmit}>
                        <CardBody className="flex flex-col gap-4">
                            <div className="flex justify-between items-center">
                                <h1 className='mt-2'>Check out from {item.name}</h1>
                            </div>
                            {!addRes.success ?
                            ...
                            {!loading ?
                                <>
                                    ...
                                    <div className="mb-2 flex items-center gap-2">
                                        <p className="w-[80px]">Check out</p>
                                        <div class="w-56">
